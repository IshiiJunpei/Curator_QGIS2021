...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="orgGILvl"/>
    <edittype labelontop="0" editable="1" type="0" name="orgMDId"/>
    <edittype labelontop="0" editable="1" type="0" name="uuid"/>
    <edittype labelontop="0" editable="1" type="0" name="名称"/>
    <edittype labelontop="0" editable="1" type="0" name="存在期間自"/>
    <edittype labelontop="0" editable="1" type="0" name="存在期間至"/>
    <edittype labelontop="0" editable="1" type="0" name="整備完了日"/>
    <edittype labelontop="0" editable="1" type="0" name="更新フラグ"/>
    <edittype labelontop="0" editable="1" type="0" name="種別"/>
    <edittype labelontop="0" editable="1" type="0" name="表示区分"/>
  </edittypes>
  <editform></editform>
